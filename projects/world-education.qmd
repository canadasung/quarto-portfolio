...
**Forked project repo:** [World Education Project](https://github.com/canadasung/ubc-dsci532-world-education.git){target="_blank"} (mirrored from school repo because it is not publicly accessible)
...
[Link to the dashboard](https://sapolraadnui-worldeducation.share.connect.posit.cloud/){target="_blank"}
